...
// 1. useReducer: takes in a reducer function and an initial state. the reducer function specifies how the state transitions from one state to the next
...
const reducer = (state, action) =>{
    // because action is an object, we access the type.
    switch(action.type){
        case 'INCREMENT':
